...
const serviceDetails: ServiceDetails = {
  "mass-text": {
    ...
    subtitle:
      "Reach your audience instantly with our powerful mass messaging solution",
    description:
      "Our enterprise-grade bulk SMS platform enables businesses to send messages to thousands of recipients simultaneously. With advanced features like scheduling, personalization, and detailed analytics, you can optimize your messaging campaigns for maximum impact.",
    benefits: [
      {
        title: "High Deliverability",
        description:
          "Direct connections with mobile operators ensure your messages reach their destination quickly and reliably.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      },
      {
        ...
        description:
          "Target specific audience segments based on demographics, behavior, or custom criteria.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      },
      {
        ...
        description:
          "Seamlessly integrate SMS capabilities into your existing applications and workflows.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
    ...
    features: [
      {
        ...
        description:
          "Create and save message templates for quick access and consistent communication.",
      },
      {
        name: "Scheduling",
        description:
          "Plan your messages to be sent at optimal times for maximum engagement.",
      },
      {
        name: "Contact Management",
        description:
          "Organize and manage your contact lists with easy import/export capabilities.",
      },
      {
        name: "Delivery Reports",
        description:
          "Get detailed reports on message delivery status and campaign performance.",
      },
    ],
    pricing: [
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes, you can schedule messages to be sent at any future date and time, with support for different time zones.",
      },
      {
    ...
    benefits: [
      {
        ...
        description:
          "Enable real-time conversations with automated or manual responses to customer messages.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      },
      {
        ...
        description:
          "Build stronger relationships through personalized, two-way conversations.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth="2"
              d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a2 2 0 01-2-2v-6a2 2 0 012-2h2V4l4 4zm-5 4v4"
            ></path>
          </svg>
        ),
      },
      {
        ...
        description:
          "Automatically create and track support tickets from SMS conversations.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      },
      {
        ...
        description:
          "Access complete message history and analytics for better customer service.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
    ...
    features: [
      {
        name: "Smart Routing",
        description:
          "Automatically route messages to the right team member or department.",
      },
      {
        name: "Quick Replies",
      ...
      },
      {
        ...
        description:
          "Keep conversations organized with automatic message threading.",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Our platform enables instant responses to incoming messages, with typical delivery times under 5 seconds.",
      },
      {
        question: "Can we have multiple agents handling messages?",
        answer:
          "Yes, you can have unlimited agents with our Business and Enterprise plans, each with their own login and permissions.",
      },
      {
        question: "Do you support automated responses?",
        answer:
          "Yes, you can set up automated responses based on keywords, time of day, or custom rules.",
      },
    ],
  },
  automated: {
    ...
    benefits: [
      {
        ...
        description:
          "Automatically adjust message delivery times for recipients in different time zones.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      },
      {
        ...
        description:
          "Set up recurring campaigns with custom frequencies and intervals.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      },
      {
        ...
        description:
          "Trigger messages based on events, user behavior, or custom conditions.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
    ...
    features: [
      ...
      },
      {
        name: "Smart Queue",
        description:
          "Optimize delivery times based on recipient engagement patterns.",
      },
      {
        name: "Campaign Rules",
        description:
          "Set complex rules and conditions for automated messaging.",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "You can schedule messages up to 12 months in advance with any of our plans.",
      },
      {
        question: "Can we modify scheduled messages?",
        answer:
          "Yes, you can edit or cancel scheduled messages any time before they are sent.",
      },
      {
        question: "Do you support recurring messages?",
        answer:
          "Yes, you can set up messages to recur daily, weekly, monthly, or at custom intervals.",
      },
    ],
  },
  personalized: {
    ...
    benefits: [
      {
        ...
        description:
          "Insert personalized content using customer data and variables.",
        icon: (
          <svg
            className="w-6 h-6"
            fill="none"
    ...
    faq: [
      {
        ...
        answer:
          "We support various types including name, custom fields, dynamic content, and conditional logic based on user data.",
      },
      {
        question: "Can we import customer data for personalization?",
        answer:
          "Yes, you can import data via CSV, API, or integrate directly with your CRM system.",
      },
      {
        question: "How do you handle data privacy?",
        answer:
          "We follow strict data protection protocols and are fully compliant with GDPR and other privacy regulations.",
      },
    ],
  },
};
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href={`https://wa.me/1234567890?text=Hi, I'm interested in the ${service.title} service. Can you provide more information?`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center bg-[#25D366] text-white px-8 py-3 rounded-full hover:bg-[#128C7E] transition-colors"
              >
                <svg
